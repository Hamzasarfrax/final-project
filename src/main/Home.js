...
<h1 className='text-center service-heading colr'>Our <span className="colar">Services</span></h1>
...
<div className='product-hover'>
  ...
  <div class="row"> 
    ...
    <p className='text-center icons-box'><BsGiftFill/></p><span>  <hr className='line-horixontal'></hr></span>
     <h1 className='text-center'>Packages</h1><hr className='horzontal'></hr>
     <p className=' text-center'>Now you can visit your dream destinations and explore the world with us. We are here to provide you mouth watering packages which includes Flights, Accommodation, Transfers, Activities, Insurance and Meal with best price.</p>
    </div>
    <div class="col-sm  col-xl-4  col-lg-4  my-5">
    <p className='text-center icons-box '><FaCcVisa/></p><span>    <hr className='line-horixontal'></hr></span>
    <h1 className='text-center'>Visa</h1><hr className='horzontal'></hr>
    <p className='text-center'>Contact with our experienced team regarding your profile and get the best advise for your future Our experienced team help you in processing your visa applications. Complete file preparation and documents assistance provided.</p>
    </div>
    <div class="col-sm col-xl-4 col-lg-4 my-5">
    <p className='text-center icons-box bas-repn'><FaBusAlt/></p><span> <hr className='line-horixontal third'></hr></span>
<h1 className='text-center'>Insurance</h1><hr className='horzontal'></hr>
<p className='text-center'>

Travel insurance provides medical and financial assistance during traveling. Before starting a trip make sure that you must be properly and securely covered for any emergency aid. 
There are many insurance companies in Pakistan for providing these services
...
<h1 className='text-center dsetinations colr' >  Top <span className='colar'>Destinations</span></h1>
<div> <p className=' text-center dsetinations py-5 set-width'>
With a world full of fascinating destinations, choosing the perfect vacation spot can present a challenge. Now you can enjoy and evaluated sights, cultures, scenic beauty, food scenes and more – to compile this list of the world's best places to visit. Some of the below destinations are the top visiting destinations now a days.</p>
